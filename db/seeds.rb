...
question1 = Question.new(title: "How do i do ajax???!!!!", body: Faker::Hacker.say_something_smart)
question1.save!

answer1 = Answer.new(body: Faker::Hacker.say_something_smart, question: question1)
answer1.save!
